$(document).ready(function() {
    ...
    $("[data-publication]").on("click", function(event){
       ...
       switch($(event.currentTarget).data("publication")){
           case "text": 
           ...
           case "image": 
            ...
            break;
           case "event": {
                navigator.geolocation.getCurrentPosition((position) => {coords = position.coords});
